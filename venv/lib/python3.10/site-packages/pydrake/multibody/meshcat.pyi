...
class ContactVisualizer(pydrake.systems.framework.LeafSystem):
    ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder, plant: pydrake.multibody.plant.MultibodyPlant, meshcat: pydrake.geometry.Meshcat, params: ContactVisualizerParams = ...) -> ContactVisualizer: ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder, contact_results_port: pydrake.systems.framework.OutputPort, query_object_port: pydrake.systems.framework.OutputPort, meshcat: pydrake.geometry.Meshcat, params: ContactVisualizerParams = ...) -> ContactVisualizer: ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder, contact_results_port: pydrake.systems.framework.OutputPort, meshcat: pydrake.geometry.Meshcat, params: ContactVisualizerParams = ...) -> ContactVisualizer: ...
...
class ContactVisualizer_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_TAutoDiffXdU):
    ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_TAutoDiffXdU, plant: pydrake.multibody.plant.MultibodyPlant_TAutoDiffXdU, meshcat: pydrake.geometry.Meshcat, params: ContactVisualizerParams = ...) -> ContactVisualizer_TAutoDiffXdU: ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_TAutoDiffXdU, contact_results_port: pydrake.systems.framework.OutputPort_TAutoDiffXdU, query_object_port: pydrake.systems.framework.OutputPort_TAutoDiffXdU, meshcat: pydrake.geometry.Meshcat, params: ContactVisualizerParams = ...) -> ContactVisualizer_TAutoDiffXdU: ...
    @overload
    @classmethod
    def AddToBuilder(cls, builder: pydrake.systems.framework.DiagramBuilder_TAutoDiffXdU, contact_results_port: pydrake.systems.framework.OutputPort_TAutoDiffXdU, meshcat: pydrake.geometry.Meshcat, params: ContactVisualizerParams = ...) -> ContactVisualizer_TAutoDiffXdU: ...
    def Delete(self) -> None: ...
...
class JointSliders(pydrake.systems.framework.LeafSystem):
    def __init__(self, meshcat: pydrake.geometry.Meshcat, plant: pydrake.multibody.plant.MultibodyPlant, initial_value: Optional[numpy.ndarray[numpy.float64[m, 1]]] = ..., lower_limit: Union[None, float, numpy.ndarray[numpy.float64[m, 1]]] = ..., upper_limit: Union[None, float, numpy.ndarray[numpy.float64[m, 1]]] = ..., step: Union[None, float, numpy.ndarray[numpy.float64[m, 1]]] = ..., decrement_keycodes: List[str] = ..., increment_keycodes: List[str] = ...) -> None: ...
    def Delete(self) -> None: ...
    def Run(self, diagram: pydrake.systems.framework.Diagram, timeout: Optional[float] = ..., stop_button_keycode: str = ...) -> numpy.ndarray[numpy.float64[m, 1]]: ...
...
class JointSliders_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_TAutoDiffXdU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, meshcat: pydrake.geometry.Meshcat, plant: pydrake.multibody.plant.MultibodyPlant_TAutoDiffXdU, initial_value: Optional[numpy.ndarray[numpy.float64[m, 1]]] = ..., lower_limit: Union[None, float, numpy.ndarray[numpy.float64[m, 1]]] = ..., upper_limit: Union[None, float, numpy.ndarray[numpy.float64[m, 1]]] = ..., step: Union[None, float, numpy.ndarray[numpy.float64[m, 1]]] = ..., decrement_keycodes: List[str] = ..., increment_keycodes: List[str] = ...) -> None: ...
    def Delete(self) -> None: ...
    def Run(self, diagram: pydrake.systems.framework.Diagram_TAutoDiffXdU, timeout: Optional[float] = ..., stop_button_keycode: str = ...) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def SetPositions(self, q: numpy.ndarray[numpy.float64[m, 1]]) -> None: ...
